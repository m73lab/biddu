...
export function ItemGallery({ images, itemName }: ItemGalleryProps) {
  ...
  return (
    <div className="mt-6">
      {/* Main Image with Navigation (click to zoom) */}
      <div
        className="relative aspect-video bg-base-200 rounded-lg overflow-hidden mb-3 cursor-zoom-in group/main"
      ...
      >
        ...
        />
        <span className="absolute top-2 right-2 badge badge-sm bg-black/50 text-white border-none gap-1 opacity-0 group-hover/main:opacity-100 transition-opacity pointer-events-none">
      ...
      {lightboxIndex !== null && (
        <ImageLightbox
          ...
          formatCounter={(current, total) => t("imageOf", { current, total })}
          prevLabel={t("previousImage")}
