...
const content = `
    ...
    <mj-text>
      Alguien (¡esperamos que tú!) intentó crear una nueva cuenta en Biddú usando este correo electrónico. Sin embargo, ya tienes una cuenta con nosotros.
    </mj-text>
    <mj-text>
...
export const accountExistsTemplate = renderLayout({
  ...
  previewText: "Ya tienes una cuenta en Biddú",
  content,
});
