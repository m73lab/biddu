...
const content = `
    ...
    <mj-text>
      ¡Gracias por crear una cuenta en Biddú! Por favor verifica tu correo electrónico haciendo clic en el botón de abajo.
    </mj-text>
    ...
    <mj-text font-size="12px" color="${theme.colors.text.muted}">
      Si no creaste una cuenta en Biddú, puedes ignorar este correo de forma segura.
    </mj-text>
    <mj-text font-size="12px" color="${theme.colors.text.muted}">
...
export const emailVerificationTemplate = renderLayout({
  ...
  previewText: "Verifica tu correo electrónico de Biddú",
  content,
});
