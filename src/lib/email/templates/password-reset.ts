...
const content = `
    ...
    <mj-text>
      Recibimos una solicitud para restablecer la contraseña de tu cuenta en Biddú. Haz clic en el botón de abajo para crear una nueva contraseña.
    </mj-text>
...
export const passwordResetTemplate = renderLayout({
  ...
  previewText: "Restablece tu contraseña de Biddú",
  content,
});
